...
All color variables properly scoped to Gradio 6.x dark mode selectors.
"""
...
/* --- Dark mode — Gradio 6.x places .dark on :root or a wrapper --- */
:root.dark,
:root .dark,
.dark {
...
/* Ensure ALL block/panel surfaces use theme variables */
.block, .panel, .container, section, fieldset,
...
label, .label-wrap span, .block > .label-wrap {
...
/* Fix Plotly wrapper backgrounds */
...
/* Gradio native input/textarea/select inherit theme */
...
.source-citation strong { color: var(--sb-accent-primary); }
...
/* --- Result Cards --- */
.result-correct  { border-left: 4px solid var(--sb-success) !important; background: rgba(34,197,94,0.05) !important; }
.result-incorrect{ border-left: 4px solid var(--sb-error)   !important; background: rgba(239,68,68,0.05) !important; }
.result-partial  { border-left: 4px solid var(--sb-warning) !important; background: rgba(245,158,11,0.05) !important; }
...
.file-item:hover { border-color: var(--sb-accent-primary); }

/* --- Scrollbar --- */
::-webkit-scrollbar { width: 6px; height: 6px; }
::-webkit-scrollbar-track { background: transparent; }
::-webkit-scrollbar-thumb { background: var(--sb-border); border-radius: 3px; }
::-webkit-scrollbar-thumb:hover { background: var(--sb-border-light); }

/* --- Responsive --- */
@media (max-width: 768px) {
    .app-header { padding: 16px 20px; flex-direction: column; align-items: flex-start; }
    .app-header h1 { font-size: 22px !important; }
    .hero-section { padding: 32px 24px; }
    .hero-section h2 { font-size: 24px !important; }
    .tab-nav button { font-size: 12px !important; padding: 8px 14px !important; }
    .header-actions { width: 100% !important; flex-direction: column !important; align-items: stretch !important; }
    .header-model-select { max-width: none !important; }
    #theme-toggle-btn { width: 100% !important; max-width: none !important; }
}
...
.markdown-content li { margin: 4px 0 !important; line-height: 1.7 !important; }

.markdown-content table { width: 100% !important; border-collapse: collapse !important; margin: 16px 0 !important; }
